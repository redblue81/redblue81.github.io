...
Nell'ambito del mio progetto di domotica casalinga, non potevano mancare le luci. Per questa parte, ho deciso di ricorrere a due dispositivi in particolare: il [Sonoff Mini R4 Extreme](https://amzn.to/4qC5Urw){:target="_blank"} e il [Sonoff Dual R3](https://amzn.to/4oSxcsf){:target="_blank"}.

Nel primo caso, il [Sonoff Mini R4 Extreme](https://amzn.to/4qC5Urw){:target="_blank"} è uno switch a due vie capace di pilotare tanto un **interruttore**, ossia il classico caso in cui abbiamo da accendere e spegnere una lampadina da un unico punto, quanto un **deviatore**, ovvero un dispositivo usato in tutti quei casi in cui abbiamo la possibilità di accendere una lampada da più punti.

Nel secondo caso invece, il [Sonoff Dual R3](https://amzn.to/4oSxcsf){:target="_blank"} è un dispositivo che nasce per pilotare i motori tubolari delle tapparelle elettriche, in quanto permettono di controllare **due fasi**, quindi appunto salita e discesa, ma può tranquillamente essere usato per pilotare delle lampade collegate ad un relè, ovvero tutti quei casi in cui si hanno due lampadine collegate ad un unico pulsante, e per l'accensione/spegnimento abbiamo il classico ciclo: click 1 -> accende solo lampada 1, click 2 -> accende solo lampada 2, click 3 -> accende entrambe, click 4 -> spegne entrambe.

Con un [Sonoff Dual R3](https://amzn.to/4oSxcsf){:target="_blank"} riusciamo ad assegnare una lampadina ad ognuno dei due canali, e quindi pilotarle entrambe con successo (ovviamente, il dispositivo va configurato opportunamente tramite l'apposita app per indicargli che sta gestendo delle luci e non un motore).

Il grande punto di forza di un [Sonoff Mini R4 Extreme](https://amzn.to/4qC5Urw){:target="_blank"} è invece la dimensione ridottissima, praticamente entra in ogni scatola, anche se già piuttosto "piena" (l'ho installato tranquillamente in una 503 standard piena di cavi, basta giocare un po' e la si chiude tranquillamente).
